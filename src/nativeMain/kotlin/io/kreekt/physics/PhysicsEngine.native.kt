...
class NativeBasicBoxShape(override val halfExtents: Vector3) : NativeBasicCollisionShape(), BoxShape {
...
class NativeBasicSphereShape(override val radius: Float) : NativeBasicCollisionShape(), SphereShape {
...
class NativeBasicCylinderShape(override val halfExtents: Vector3) : NativeBasicCollisionShape(), CylinderShape {
...
class NativeBasicConvexHullShape(override val vertices: FloatArray) : NativeBasicCollisionShape(), ConvexHullShape {
