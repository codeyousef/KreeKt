...
/**
 * Native implementation of AR system internal functions
 */

// AR System platform implementations for Native
...
internal actual fun enablePlatformPlaneDetection(enabled: Boolean) {
    // Native platforms don't support plane detection
}
...
internal actual fun enablePlatformEnvironmentProbes(enabled: Boolean) {
    // Native platforms don't support environment probes
}
...
internal actual fun enablePlatformOcclusion(enabled: Boolean) {
    // Native platforms don't support occlusion
}
...
internal actual fun enablePlatformPeopleOcclusion(enabled: Boolean) {
    // Native platforms don't support people occlusion
}
