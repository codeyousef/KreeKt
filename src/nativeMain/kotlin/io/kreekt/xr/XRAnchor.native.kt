...
internal actual suspend fun checkPlatformTrackingState(anchorId: String): XRTrackingState = XRTrackingState.NOT_TRACKING

internal actual fun recalculatePoseFromOrigin(pose: XRPose, originTransform: io.kreekt.core.math.Matrix4): XRPose = pose

internal actual fun evaluatePlatformTrackingQuality(): TrackingQuality = TrackingQuality.NONE

internal actual fun getPlatformSpaceTransform(fromSpace: XRReferenceSpace, toSpace: XRReferenceSpace): io.kreekt.core.math.Matrix4 = io.kreekt.core.math.Matrix4.IDENTITY
