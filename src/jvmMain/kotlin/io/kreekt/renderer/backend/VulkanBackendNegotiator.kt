...
class VulkanBackendNegotiator : AbstractBackendNegotiator() {
        ...
        try {
            MemoryStack.stackPush().use { stack ->
                ...
                try {
                    ...
                    val osName = try { java.lang.System.getProperty("os.name") } catch (e: Exception) { "Unknown" }
                    val osVersion = try { java.lang.System.getProperty("os.version") } catch (e: Exception) { "" }
    ...
    private fun createVulkanInstance(stack: MemoryStack): VkInstance? {
        val appInfo = VkApplicationInfo.calloc(stack)
            ...
            .pEngineName(stack.UTF8("KreeKt Engine"))
    ...
    private fun supportsRayTracing(physicalDevice: VkPhysicalDevice, stack: MemoryStack): Boolean {
        ...
        vkEnumerateDeviceExtensionProperties(physicalDevice, null as String?, pExtensionCount, extensions)
    ...
    private fun createUnsupportedReport(reason: String): DeviceCapabilityReport {
        return DeviceCapabilityReport(
            ...
            driverVersion = "N/A",
            osBuild = (try { java.lang.System.getProperty("os.name") } catch (e: Exception) { "Unknown" }) + " " +
                      (try { java.lang.System.getProperty("os.version") } catch (e: Exception) { "" }),
            featureFlags = mapOf(
