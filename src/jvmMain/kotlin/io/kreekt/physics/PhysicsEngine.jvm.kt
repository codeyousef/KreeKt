        ...
        for (i in 0 until subSteps) {
            ...
            rigidBodies.forEach { body ->
                if (body.bodyType == RigidBodyType.DYNAMIC && body.isActive()) {
                    ...
                    // Apply damping
                    body.linearVelocity = body.linearVelocity.times(1f - body.linearDamping * subDeltaTime)
                    body.angularVelocity = body.angularVelocity.times(1f - body.angularDamping * subDeltaTime)
                }
            }
