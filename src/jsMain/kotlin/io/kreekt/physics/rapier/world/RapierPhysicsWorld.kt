 ...
 */
package io.kreekt.physics.rapier.world
...
private fun fromRapierVector3(v: dynamic): Vector3 = Vector3(v.x as Float, v.y as Float, v.z as Float)

private fun toRapierQuaternion(q: Quaternion): RAPIER.Quaternion = RAPIER.Quaternion(q.x, q.y, q.z, q.w)

private fun fromRapierQuaternion(q: dynamic): Quaternion = Quaternion(q.x as Float, q.y as Float, q.z as Float, q.w as Float)
