...
class RapierPointToPointConstraint(
    bodyA: RigidBody,
    bodyB: RigidBody?,
    private var _pivotA: io.kreekt.core.math.Vector3,
    private var _pivotB: io.kreekt.core.math.Vector3
    ...
    override val pivotA: io.kreekt.core.math.Vector3
        get() = _pivotA

    override val pivotB: io.kreekt.core.math.Vector3
        get() = _pivotB
    ...
    override fun setPivotA(pivot: io.kreekt.core.math.Vector3) {
        _pivotA = pivot
    }

    override fun setPivotB(pivot: io.kreekt.core.math.Vector3) {
        _pivotB = pivot
    }
...
class RapierHingeConstraint(
    ...
    override val pivotA: io.kreekt.core.math.Vector3,
    override val pivotB: io.kreekt.core.math.Vector3,
    override val axisA: io.kreekt.core.math.Vector3,
    override val axisB: io.kreekt.core.math.Vector3
) : HingeConstraint {
...
class RapierSliderConstraint(
    bodyA: RigidBody,
    bodyB: RigidBody?,
    override val frameA: io.kreekt.core.math.Matrix4,
    override val frameB: io.kreekt.core.math.Matrix4
) : SliderConstraint {
