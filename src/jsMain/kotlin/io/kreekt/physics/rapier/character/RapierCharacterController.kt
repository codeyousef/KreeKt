 ...
 */
package io.kreekt.physics.rapier.character

import io.kreekt.core.math.Vector3
import io.kreekt.physics.CharacterController
import io.kreekt.physics.CollisionShape
import io.kreekt.physics.PhysicsOperationResult
import io.kreekt.physics.PhysicsWorld
...
class RapierCharacterController(
    ...
    override var transform = io.kreekt.core.math.Matrix4()
    ...
    override fun setWorldTransform(transform: io.kreekt.core.math.Matrix4) {
        this.transform.copy(transform)
    }

    override fun getWorldTransform(): io.kreekt.core.math.Matrix4 {
    ...
    override fun rotate(rotation: io.kreekt.core.math.Quaternion) {
