/**
 * Rapier complex collision shapes (ConvexHull, TriangleMesh, Heightfield, Compound)
 */
...
internal class RapierConvexHullShape(
...
internal class RapierTriangleMeshShape(
    override val vertices: FloatArray,
    ...
    override fun buildBVH(): MeshBVH = createSimpleMeshBVH(this)
    ...
    private fun triangleIntersectsAABB(triangle: PhysicsTriangle, aabbMin: Vector3, aabbMax: Vector3): Boolean {
        val triMin = Vector3(
...
internal class RapierHeightfieldShape(
...
internal class RapierCompoundShape : CompoundShape {
...
private fun calculateTrianglesBounds(triangles: List<PhysicsTriangle>): Box3 {
