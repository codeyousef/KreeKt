...
class JsPhysicsEngine : PhysicsEngine {
    ...
    override fun createPointToPointConstraint(
        ...
        return JsBasicPointToPointConstraint(bodyA, bodyB, pivotA, pivotB)
    }
    ...
    override fun createHingeConstraint(
        ...
        return JsBasicHingeConstraint(bodyA, bodyB, pivotA, pivotB, axisA, axisB)
    }
    ...
    override fun createSliderConstraint(
        ...
        return JsBasicSliderConstraint(bodyA, bodyB, frameA, frameB)
    }
}
 ...
 */
class JsBasicPhysicsWorld(override var gravity: Vector3) : PhysicsWorld {
...
abstract class JsBasicCollisionShape : CollisionShape {
...
class JsBasicBoxShape(override val halfExtents: Vector3) : JsBasicCollisionShape(), BoxShape {
...
class JsBasicSphereShape(override val radius: Float) : JsBasicCollisionShape(), SphereShape {
...
class JsBasicCapsuleShape(
    override val radius: Float,
    override val height: Float
) : JsBasicCollisionShape(), CapsuleShape {
...
class JsBasicCylinderShape(override val halfExtents: Vector3) : JsBasicCollisionShape(), CylinderShape {
...
class JsBasicConeShape(
    override val radius: Float,
    override val height: Float
) : JsBasicCollisionShape(), ConeShape {
...
class JsBasicConvexHullShape(override val vertices: FloatArray) : JsBasicCollisionShape(), ConvexHullShape {
...
class JsBasicTriangleMeshShape(
    override val vertices: FloatArray,
    override val indices: IntArray
) : JsBasicCollisionShape(), TriangleMeshShape {
...
class JsBasicHeightfieldShape(
    override val width: Int,
    override val height: Int,
    override val heightData: FloatArray
) : JsBasicCollisionShape(), HeightfieldShape {
...
class JsBasicCompoundShape : JsBasicCollisionShape(), CompoundShape {
...
class JsBasicCharacterController(
    override var collisionShape: CollisionShape,
...
class JsBasicPointToPointConstraint(
