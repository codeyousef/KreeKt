...
external interface GPUBuffer {
    ...
    fun destroy()
    fun mapAsync(mode: Int, offset: Int = definedExternally, size: Int = definedExternally): dynamic /* Promise<void> */
    fun getMappedRange(offset: Int = definedExternally, size: Int = definedExternally): dynamic /* ArrayBuffer */
    fun unmap()
}
...
external interface GPURenderPassEncoder {
    ...
    fun setBindGroup(index: Int, bindGroup: GPUBindGroup?, dynamicOffsets: IntArray = definedExternally)
    fun setVertexBuffer(slot: Int, buffer: GPUBuffer?, offset: Int = definedExternally, size: Int = definedExternally)
    fun setIndexBuffer(buffer: GPUBuffer, indexFormat: String, offset: Int = definedExternally, size: Int = definedExternally)
...
external interface GPUQueue {
    ...
    fun writeBuffer(buffer: GPUBuffer, bufferOffset: Int, data: dynamic, dataOffset: Int = definedExternally, size: Int = definedExternally)
