...
/**
 * Wrapper implementations to bridge ARCore types with KreeKt XR interfaces
 */
    ...
    override val intrinsics: CameraIntrinsics?
        get() {
            ...
            return CameraIntrinsics(
                ...
                principalPoint = Vector2(arIntrinsics.principalPoint[0], arIntrinsics.principalPoint[1]),
                imageSize = Vector2(
...
class ARCoreLightEstimate(private val lightEstimate: LightEstimate) : XRLightEstimate {
    ...
    override val sphericalHarmonicsCoefficients: List<Vector3>
        get() {
            val harmonics = lightEstimate.environmentalHdrAmbientSphericalHarmonics ?: return emptyList()
    ...
    override val primaryLightDirection: Vector3
        get() {
            val direction = lightEstimate.environmentalHdrMainLightDirection ?: floatArrayOf(0f, -1f, 0f)
            return Vector3(direction[0], direction[1], direction[2])
        }

    override val primaryLightIntensity: Float
        get() {
            val intensity = lightEstimate.environmentalHdrMainLightIntensity ?: floatArrayOf(1f, 1f, 1f)
...
/**
 * Convert ARCore matrix to KreeKt Matrix4
 */
