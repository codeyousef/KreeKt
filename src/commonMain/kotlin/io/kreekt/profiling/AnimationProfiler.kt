...
object AnimationProfiler {
    ...
    fun <T> profileMixerUpdate(deltaTime: Float, actionCount: Int, block: () -> T): T {
        ...
        PerformanceProfiler.recordCounter("animation.mixer.deltaTimeMs", (deltaTime * 1000).toLong())
        return PerformanceProfiler.measure("animation.mixer.update", ProfileCategory.ANIMATION, block)
    }
    ...
    fun <T> profileSkeletalUpdate(boneCount: Int, block: () -> T): T {
        ...
        return PerformanceProfiler.measure("animation.skeletal.update", ProfileCategory.ANIMATION, block)
    }
    ...
    fun <T> profileMorphTargetBlending(targetCount: Int, block: () -> T): T {
        ...
        return PerformanceProfiler.measure("animation.morph.blend", ProfileCategory.ANIMATION, block)
    }
    ...
    fun <T> profileStateTransition(fromState: String, toState: String, block: () -> T): T {
        return PerformanceProfiler.measure("animation.stateMachine.transition.$fromState-$toState", ProfileCategory.ANIMATION, block)
    }
    ...
    fun <T> profileStateMachineUpdate(stateCount: Int, block: () -> T): T {
        ...
        return PerformanceProfiler.measure("animation.stateMachine.update", ProfileCategory.ANIMATION, block)
    }

    /**
     * Profile keyframe interpolation
     */
    fun <T> profileKeyframeInterpolation(keyframeCount: Int, interpolationType: String, block: () -> T): T {
        PerformanceProfiler.recordCounter("animation.keyframes.count", keyframeCount.toLong())
        return PerformanceProfiler.measure("animation.interpolation.$interpolationType", ProfileCategory.ANIMATION, block)
    }
    ...
    fun <T> profileClipPlayback(clipName: String, duration: Float, block: () -> T): T {
        ...
        return PerformanceProfiler.measure("animation.clip.$clipName", ProfileCategory.ANIMATION, block)
    }
    ...
    fun <T> profileBlending(blendMode: String, trackCount: Int, block: () -> T): T {
        ...
        return PerformanceProfiler.measure("animation.blend.$blendMode", ProfileCategory.ANIMATION, block)
    }
    ...
    fun <T> profilePoseGeneration(block: () -> T): T {
        return PerformanceProfiler.measure("animation.pose.generate", ProfileCategory.ANIMATION, block)
    }
    ...
    fun <T> profileCompression(
        ...
        PerformanceProfiler.recordCounter("animation.compression.original", originalKeyframes.toLong())
        PerformanceProfiler.recordCounter("animation.compression.compressed", compressedKeyframes.toLong())
    ...
    fun analyzeAnimationComplexity(
        ...
        return PerformanceProfiler.measure("animation.analyzeComplexity", ProfileCategory.ANIMATION) {
