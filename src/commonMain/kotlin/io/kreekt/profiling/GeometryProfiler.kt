...
object GeometryProfiler {
    ...
    fun <T> profileAttributeCreation(name: String, block: () -> T): T {
        return PerformanceProfiler.measure("geometry.createAttribute.$name", ProfileCategory.GEOMETRY, block)
    }
    ...
    fun <T> profileVertexBufferGeneration(vertexCount: Int, block: () -> T): T {
        ...
        return PerformanceProfiler.measure("geometry.generateVertexBuffer", ProfileCategory.GEOMETRY, block)
    }
    ...
    fun <T> profileIndexBufferGeneration(indexCount: Int, block: () -> T): T {
        ...
        return PerformanceProfiler.measure("geometry.generateIndexBuffer", ProfileCategory.GEOMETRY, block)
    }
    ...
    fun <T> profileNormalCalculation(block: () -> T): T {
        return PerformanceProfiler.measure("geometry.computeNormals", ProfileCategory.GEOMETRY, block)
    }
    ...
    fun <T> profileTangentCalculation(block: () -> T): T {
        return PerformanceProfiler.measure("geometry.computeTangents", ProfileCategory.GEOMETRY, block)
    }
    ...
    fun <T> profileBoundingVolumeCalculation(block: () -> T): T {
        return PerformanceProfiler.measure("geometry.computeBoundingVolume", ProfileCategory.GEOMETRY, block)
    }
    ...
    fun <T> profileMeshSimplification(
        ...
        PerformanceProfiler.recordCounter("geometry.simplification.originalTriangles", originalTriangles.toLong())
        PerformanceProfiler.recordCounter("geometry.simplification.targetTriangles", targetTriangles.toLong())
    ...
    fun <T> profileOptimization(optimizationType: String, block: () -> T): T {
        return PerformanceProfiler.measure("geometry.optimize.$optimizationType", ProfileCategory.GEOMETRY, block)
    }
    ...
    fun <T> profilePrimitiveGeneration(primitiveType: String, block: () -> T): T {
        return PerformanceProfiler.measure("geometry.primitive.$primitiveType", ProfileCategory.GEOMETRY, block)
    }
