 ...
 */
internal fun Matrix4.composeFromPQS(position: Vector3, quaternion: Quaternion, scale: Vector3): Matrix4 {
 ...
 */
internal fun Matrix4.decomposeToPQS(position: Vector3, quaternion: Quaternion, scale: Vector3): Matrix4 {
    // Extract position
