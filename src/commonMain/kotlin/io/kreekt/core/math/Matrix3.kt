...
data class Matrix3(
     ...
     */
    fun invert(): Matrix3 {
        val n11 = elements[0]; val n21 = elements[1]; val n31 = elements[2]
        val n12 = elements[3]; val n22 = elements[4]; val n32 = elements[5]
        val n13 = elements[6]; val n23 = elements[7]; val n33 = elements[8]
     ...
     */
    fun setUvTransform(tx: Float, ty: Float, sx: Float, sy: Float, rotation: Float, cx: Float, cy: Float): Matrix3 {
        val c = cos(rotation)
        val s = sin(rotation)
