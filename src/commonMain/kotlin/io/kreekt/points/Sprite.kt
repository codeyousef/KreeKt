...
open class Sprite(
    ...
    fun raycast(raycaster: Raycaster, intersects: MutableList<Intersection>) {
        ...
        if (rayIntersectsTriangle(raycaster.ray, vertices[0], vertices[1], vertices[2], intersectionPoint) ||
            rayIntersectsTriangle(raycaster.ray, vertices[0], vertices[2], vertices[3], intersectionPoint)
        ) {
