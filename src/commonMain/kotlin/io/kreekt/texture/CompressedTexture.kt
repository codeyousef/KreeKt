...
class CompressedTexture(
     ...
     */
    fun getMipmap(level: Int): CompressedTextureMipmap? = compressedMipmaps.find { it.level == level }
    ...
    override fun clone(): CompressedTexture = CompressedTexture(width, height, compressedFormat).apply {
