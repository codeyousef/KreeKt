...
sealed class VerificationError(open val message: String, open val cause: Throwable? = null) {
    ...
    data class CompilationError(override val message: String, val errors: List<String>) : VerificationError(message)
...
data class ImplementationTask(
    ...
    val estimatedEffort: io.kreekt.verification.model.Duration,
...
data class ProgressReport(
    ...
    val estimatedCompletion: io.kreekt.verification.model.Duration?
)
