package io.kreekt.verification.patterns

import io.kreekt.verification.DetectionPattern
import io.kreekt.verification.model.PlaceholderType
import io.kreekt.verification.model.Severity
...
object StandardPatterns {
    ...
    /**
     * KreeKt library specific patterns for 3D graphics placeholders
     */
    val KREEKT_SPECIFIC = listOf(
        DetectionPattern(
            type = PlaceholderType.STUB,
    ...
    ) + KOTLIN_SPECIFIC + KREEKT_SPECIFIC + PERFORMANCE_PLACEHOLDERS + TEST_PLACEHOLDERS
