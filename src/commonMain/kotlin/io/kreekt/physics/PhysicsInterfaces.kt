/**
 * Physics interfaces for the KreeKt physics system
...
interface PhysicsWorld {
    ...
    fun boxCast(center: Vector3, halfExtents: Vector3, rotation: Quaternion, groups: Int = -1): List<CollisionObject>
...
interface RigidBody : CollisionObject {
    ...
    fun applyImpulse(impulse: Vector3, relativePosition: Vector3 = Vector3.ZERO): PhysicsResult<Unit>
...
interface HingeConstraint : PhysicsConstraint {
    ...
    fun setLimit(low: Float, high: Float, softness: Float = 0.9f, biasFactor: Float = 0.3f, relaxationFactor: Float = 1f)
...
interface ConeTwistConstraint : PhysicsConstraint {
    ...
    fun setLimit(swingSpan1: Float, swingSpan2: Float, twistSpan: Float, softness: Float = 1f, biasFactor: Float = 0.3f, relaxationFactor: Float = 1f)
    fun enableMotor(enable: Boolean)
...
interface PhysicsEngine {
     ...
     * Constraint creation
     */
    fun createPointToPointConstraint(bodyA: RigidBody, bodyB: RigidBody?, pivotA: Vector3, pivotB: Vector3): PointToPointConstraint
