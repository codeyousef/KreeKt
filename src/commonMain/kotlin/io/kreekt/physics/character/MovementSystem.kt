...
object MovementSystem {
    ...
    fun performHorizontal(
        ...
        while (remainingDistance > 0.001f && slideIterations < maxSlideIterations) {
            ...
            // Perform sweep test
            val sweepResult = SweepTester.sweep(world, currentPosition, testPosition, characterRadius, characterHeight)
    ...
    fun performVertical(
        ...
        val sweepResult = SweepTester.sweep(world, startPosition, testPosition, characterRadius, characterHeight)
