...
import io.kreekt.physics.CollisionObject
...
class PlatformTracker {
    ...
    fun update(groundObject: CollisionObject?) {
        if (groundObject == currentPlatform) {
            ...
            val currentPlatformPos = groundObject?.getWorldTransform()?.getTranslation() ?: Vector3.ZERO
            ...
            lastPlatformPosition = groundObject?.getWorldTransform()?.getTranslation() ?: Vector3.ZERO
