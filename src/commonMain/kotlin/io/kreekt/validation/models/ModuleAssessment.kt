...
import io.kreekt.validation.ValidationStatus
 ...
 * performance metrics, and issues for individual KreeKt modules.
 */
@Serializable
data class ModuleAssessment(
    /**
     * Name of the module (e.g., "kreekt-core", "kreekt-renderer").
     */
