package io.kreekt.validation.renderer
 ...
 * measurement capabilities across all supported KreeKt platforms.
 */
class DefaultRendererFactory : RendererFactory {
    ...
    override suspend fun validateRenderer(
        ...
        return try {
            ...
            if (missingFeatures.isNotEmpty()) issues.add("Missing critical features: ${missingFeatures.joinToString(", ")}")
    ...
    private fun generatePerformanceMetrics(platform: Platform, renderer: Renderer): PerformanceData {
    ...
    private fun calculateTestCoverage(validationSuite: RendererValidationSuite, capabilityCount: Int): Float {
        var coverage = 0.0f
