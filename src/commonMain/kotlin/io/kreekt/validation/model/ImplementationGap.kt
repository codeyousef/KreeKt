package io.kreekt.validation.model
...
data class ImplementationGap(
    ...
    fun validate(): SimpleValidationResult {
        ...
        // Validate platforms are supported KreeKt targets
    ...
    /**
     * Gets the subset of platforms that are critical for KreeKt core functionality.
...
/**
 * Supported KreeKt platform targets.
 */
@Serializable
enum class Platform {
