...
class ShaderCompiler {
    ...
    private suspend fun compileForWeb(source: String, type: ShaderType, options: CompilationOptions): CompiledShader {
        return CompiledShader(source.encodeToByteArray(), type, source)
    }

    private suspend fun compileForJVM(source: String, type: ShaderType, options: CompilationOptions): CompiledShader {
        return CompiledShader(source.encodeToByteArray(), type, source)
    }

    private suspend fun compileForAndroid(source: String, type: ShaderType, options: CompilationOptions): CompiledShader {
        return CompiledShader(source.encodeToByteArray(), type, source)
    }

    private suspend fun compileForIOS(source: String, type: ShaderType, options: CompilationOptions): CompiledShader {
        return CompiledShader(source.encodeToByteArray(), type, source)
    }

    private suspend fun compileForNative(source: String, type: ShaderType, options: CompilationOptions): CompiledShader {
        return CompiledShader(source.encodeToByteArray(), type, source)
    }
    /**
