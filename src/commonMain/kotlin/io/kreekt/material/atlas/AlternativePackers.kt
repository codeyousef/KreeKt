 ...
 */
fun createPackerByStrategy(strategy: io.kreekt.material.PackingStrategy): RectanglePacker {
    return when (strategy) {
        io.kreekt.material.PackingStrategy.MAX_RECTS -> MaxRectsPackager()
        io.kreekt.material.PackingStrategy.SKYLINE -> SkylinePackager()
        io.kreekt.material.PackingStrategy.GUILLOTINE -> GuillotinePackager()
        io.kreekt.material.PackingStrategy.SHELF -> BottomLeftPackager()
    }
}
