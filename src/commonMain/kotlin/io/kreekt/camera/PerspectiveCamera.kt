...
class PerspectiveCamera(
     ...
     */
    fun createRayFromScreen(screenX: Float, screenY: Float, screenWidth: Float, screenHeight: Float): Ray {
...
class PerspectiveCameraBuilder {
    ...
    fun fov(fov: Float) { this.fov = fov }
    fun aspect(aspect: Float) { this.aspect = aspect }
    fun near(near: Float) { this.near = near }
    fun far(far: Float) { this.far = far }
    fun zoom(zoom: Float) { this.zoom = zoom }
