...
internal object SphericalHarmonicsProcessor {
    ...
    suspend fun computeSphericalHarmonics(
        ...
        try {
            ...
            cache[cacheKey] = sh
            io.kreekt.lighting.ibl.IBLResult.Success(sh)
        } catch (e: Exception) {
            io.kreekt.lighting.ibl.IBLResult.Error("CubemapGenerationFailed: Failed to generate spherical harmonics, ${e.message}")
        }
    }
