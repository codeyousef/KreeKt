...
import io.kreekt.lighting.probe.*
import kotlinx.coroutines.*

// Type aliases for compatibility
typealias ProbeVolumeImpl = io.kreekt.lighting.probe.ProbeVolume
typealias CompressedProbeDataImpl = io.kreekt.lighting.probe.CompressedProbeData
...
class LightProbeBakerImpl : LightProbeBaker {
    ...
    suspend fun bakeLightmaps(scene: Scene, resolution: Int): BakeResult<List<Texture2D>> =
