...
class AmbientLightImpl(
    ...
    companion object {
         ...
         */
        fun soft(color: Color = Color(0.4f, 0.4f, 0.4f), intensity: Float = 0.6f): AmbientLightImpl =
...
class RectAreaLightImpl(
    ...
    override var castShadow: Boolean = false // Rect area lights typically don't cast shadows in real-time
    override var shadowMapSize: Int = 512
    override var shadowBias: Float = 0f
    override var shadowNormalBias: Float = 0f
    override var shadowRadius: Float = 1f
