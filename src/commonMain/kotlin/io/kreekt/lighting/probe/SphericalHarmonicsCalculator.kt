...
class SphericalHarmonicsImpl(
...
) : io.kreekt.lighting.SphericalHarmonics {
    /**
     ...
     */
    fun add(other: io.kreekt.lighting.SphericalHarmonics) {
        for (i in coefficients.indices) {
...
class SphericalHarmonicsGenerator {
     ...
     */
    fun generateFromCubemap(cubemap: CubeTexture): io.kreekt.lighting.SphericalHarmonics {
