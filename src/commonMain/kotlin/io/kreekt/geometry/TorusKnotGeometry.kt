...
class TorusKnotGeometry(
    ...
    override val parameters = TorusKnotParameters(radius, tube, tubularSegments, radialSegments, p, q)
    ...
    override fun generate() {
        ...
        for (i in 0..params.tubularSegments) {
            val u = i.toFloat() / params.tubularSegments.toFloat() * params.p.toFloat() * PI.toFloat() * 2f
