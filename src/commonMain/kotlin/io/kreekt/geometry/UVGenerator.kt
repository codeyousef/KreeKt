...
import io.kreekt.geometry.uvgen.*
...
class UVGenerator {
    ...
    ): UVGenerationResult = io.kreekt.geometry.uvgen.generateBoxUV(geometry, options)
    ...
    ): UVGenerationResult = io.kreekt.geometry.uvgen.generateCylindricalUV(geometry, options)
    ...
    ): UVGenerationResult = io.kreekt.geometry.uvgen.generateSphericalUV(geometry, options)
    ...
    ): UVGenerationResult = io.kreekt.geometry.uvgen.generatePlanarUV(geometry, options)
    ...
    ): UVGenerationResult = io.kreekt.geometry.uvgen.generateUnwrappedUV(geometry, options)
    ...
    ): UVOptimizationResult = io.kreekt.geometry.uvgen.optimizeUVLayout(geometry, options)
