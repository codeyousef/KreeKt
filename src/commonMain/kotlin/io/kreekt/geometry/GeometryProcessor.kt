...
import io.kreekt.geometry.processing.*
...
class GeometryProcessor {
    ...
    fun generateLodLevels(
        ...
        options: io.kreekt.geometry.processing.LodGenerationOptions = io.kreekt.geometry.processing.LodGenerationOptions()
    ): io.kreekt.geometry.processing.LodResult = lodGenerator.generateLodLevels(geometry, options)
