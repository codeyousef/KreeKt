...
class IosMoltenVkNegotiator : AbstractBackendNegotiator() {
    ...
    private fun getIOSVersion(): String {
        ...
        val versionString = "${version.majorVersion}.${version.minorVersion}.${version.patchVersion}"

        // Determine if iOS or visionOS
        return if (processInfo.operatingSystemVersionString.contains("visionOS", ignoreCase = true)) {
