...
class CubeTextureContractTest {
    ...
    fun testCubeTextureSampling() {
        ...
        assertEquals(CubeReflectionMapping, cubeTexture.mapping, "Should use cube reflection mapping")

        // Alternative mappings
        cubeTexture.mapping = CubeRefractionMapping
        assertEquals(CubeRefractionMapping, cubeTexture.mapping, "Should support refraction mapping")
    }
