package io.kreekt.validation.suite
...
class TestSuiteValidationTest {
    ...
    fun testExecuteTestSuiteValidation() = runTest {
        ...
        val completedTests = testResult.passedTests + testResult.failedTests + testResult.skippedTests
        assertEquals(
    ...
    fun testValidateTestIntegration() = runTest {
        ...
        val testScore =
            validationResult.componentScores["testing"] ?: validationResult.componentScores["test_suite"] ?: 0f
    ...
    fun testValidateTestPerformance() = runTest {
        ...
        if (testResult.totalTests > 0) {
            ...
            val avgTimePerTest = testResult.executionTimeMs.toFloat() / testResult.totalTests.toFloat()
            assertTrue(
    ...
    fun testValidateConstitutionalTestCompliance() = runTest {
        ...
        assertTrue(
            complianceResult.constitutionalRequirements.any { it.key.contains("test", ignoreCase = true) },
