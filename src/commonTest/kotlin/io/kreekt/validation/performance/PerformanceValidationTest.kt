package io.kreekt.validation.performance
...
class PerformanceValidationTest {
    ...
    fun testPerformanceIssuesDetection() = runTest {
        ...
        assertNotNull(performanceResult.performanceIssues, "Performance issues list should not be null")
    ...
    fun testPerformanceValidationIntegration() = runTest {
        ...
        assertNotNull(validationResult.performanceValidation, "Performance validation should be included")
    ...
    fun testConstitutionalPerformanceCompliance() = runTest {
        ...
        assertTrue(
            complianceResult.constitutionalRequirements.any { it.key.contains("performance", ignoreCase = true) },
    ...
    fun testPerformanceValidationCompleteness() = runTest {
        ...
        assertNotNull(performanceResult.meetsSizeRequirement, "Size requirement evaluation should be present")
