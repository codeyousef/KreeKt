...
class LightCameraHelpersContractTest {
    ...
    fun testCameraHelperShowsFrustum() {
        ...
        assertTrue(cameraHelper.pointMap.isNotEmpty(), "CameraHelper pointMap should contain frustum points")
    }
    ...
    fun testDirectionalLightHelperShowsDirection() {
        ...
        assertEquals(0xFF0000, lightHelper.color?.getHex(), "DirectionalLightHelper color should match")
