...
class PerformanceProfilerTest {
    ...
    fun testReset() {
        ...
        assertTrue(PerformanceProfiler.getFrameStats().frameCount > 0, "Should have frames before reset")
        assertTrue(PerformanceProfiler.getHotspots().isNotEmpty(), "Should have hotspots before reset")

        PerformanceProfiler.reset()

        assertEquals(0, PerformanceProfiler.getFrameStats().frameCount, "Should have no frames after reset")
        assertTrue(PerformanceProfiler.getHotspots().isEmpty(), "Should have no hotspots after reset")
    }
}
...
class ProfilingReportTest {
    ...
    fun testTextReportGeneration() {
        ...
        assertTrue(textReport.contains("KreeKt Performance Report"), "Should contain header")
    ...
    fun testHtmlReportGeneration() {
        ...
        assertTrue(htmlReport.contains("KreeKt Performance Report"), "Should contain title")
    }
}
...
class ProfilingDashboardTest {
    ...
    fun testFormattedText() {
        ...
        assertTrue(text.contains("KreeKt Performance Dashboard"), "Should contain header")
    }
}
