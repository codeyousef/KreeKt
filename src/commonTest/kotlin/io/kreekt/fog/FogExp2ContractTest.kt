...
class FogExp2ContractTest {
    ...
    fun testFogExp2Creation() {
        ...
        // Verify parameters
        assertEquals(0xCCCCCC, fog.color.getHex(), "FogExp2 color should match constructor parameter")
    ...
    fun testFogExp2Clone() {
        ...
        assertEquals(original.color.getHex(), cloned.color.getHex(), "Cloned fog should have same color")
        ...
        assertEquals(0.002f, original.density, "Original fog should not be affected by clone modifications")
    }
    ...
    fun testFogExp2MinimalDensity() {
        ...
        assertTrue(factorAt100 > 0.9f, "Minimal density should produce minimal fog at moderate distances")
    }
