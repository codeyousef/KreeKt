...
class FogContractTest {
    ...
    fun testFogLinearInterpolation() {
        ...
        assertEquals(1.0f, factorBeforeNear, 0.01f, "Fog factor should be clamped to 1.0 before near")
    ...
    fun testFogClone() {
        ...
        cloned.near = 50f
        assertEquals(20f, original.near, "Original fog should not be affected by clone modifications")
    }
