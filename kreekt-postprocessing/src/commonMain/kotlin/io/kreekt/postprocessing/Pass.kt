...
import io.kreekt.core.Disposable
...
abstract class Pass : Disposable {
     ...
     */
    abstract fun render(
        renderer: io.kreekt.postprocessing.Renderer,
        writeBuffer: io.kreekt.postprocessing.RenderTarget,
        readBuffer: io.kreekt.postprocessing.RenderTarget,
        deltaTime: Float,
        maskActive: Boolean
    )
...
abstract class FullScreenPass : Pass() {
    ...
    protected fun renderFullScreen(
        renderer: io.kreekt.postprocessing.Renderer,
        material: io.kreekt.postprocessing.ShaderMaterial,
        renderTarget: io.kreekt.postprocessing.RenderTarget?
    ) {
...
abstract class MaskPass : Pass() {
     ...
     */
    protected fun clearStencil(renderer: io.kreekt.postprocessing.Renderer) {
     ...
     */
    protected fun writeStencil(renderer: io.kreekt.postprocessing.Renderer, value: Int) {
     ...
     */
    protected fun testStencil(renderer: io.kreekt.postprocessing.Renderer, value: Int) {
        renderer.state.buffers.stencil.setTest(true)
...
class FullScreenQuad : Disposable {
    fun render(renderer: io.kreekt.postprocessing.Renderer, material: io.kreekt.postprocessing.ShaderMaterial) {
