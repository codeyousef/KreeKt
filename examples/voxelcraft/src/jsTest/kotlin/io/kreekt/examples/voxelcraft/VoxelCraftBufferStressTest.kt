...
class VoxelCraftBufferStressTest {
    ...
    fun testTypicalChunkCountWithinCapacity() {
        ...
        assertTrue(typicalChunkCount < bufferCapacity,
    ...
    fun testStressScenarioWithinCapacity() {
        ...
        assertTrue(stressChunkCount < bufferCapacity,
    ...
    fun testChunkUnloadingPreventsOverflow() {
        ...
        assertTrue(maxExpectedChunks < absoluteMaxChunks,
    ...
    fun testInitialWorldGenerationWithinCapacity() {
        ...
        assertTrue(initialChunks < bufferCapacity,
        ...
        assertTrue(utilizationPercent < 50,
    ...
    fun testPlayerMovementChunkExpansion() {
        ...
        assertTrue(afterMovementChunks > initialChunks,
            "Chunk count should increase after player movement")
        assertTrue(afterMovementChunks < bufferCapacity,
    ...
    fun testRapidMovementChunkThrashing() {
        ...
        assertTrue(peakChunkCount < bufferCapacity,
