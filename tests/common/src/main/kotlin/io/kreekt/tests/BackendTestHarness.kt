package io.kreekt.tests

import io.kreekt.renderer.backend.*
import io.kreekt.renderer.metrics.*
    ...
    suspend fun simulateNegotiationWithFixture(fixture: DeviceCapabilityFixture): BackendSelection {
        ...
        val profiles = listOf(
            RenderingBackendProfile(
                ...
                supportedFeatures = setOf(BackendFeature.COMPUTE, BackendFeature.RAY_TRACING, BackendFeature.XR_SURFACE),
            ...
            RenderingBackendProfile(
                ...
                platformTargets = listOf(PlatformTarget.DESKTOP, PlatformTarget.ANDROID, PlatformTarget.IOS)
            )
        )
