...
internal class CriteriaExtractor {
    ...
    fun extractCriteria(result: ValidationResult, validatorName: String): List<ValidationCriterion> {
        ...
        when (result) {
            ...
            is ConstitutionalCompliance -> extractConstitutionalCriteria(criteria, result, validatorName)
