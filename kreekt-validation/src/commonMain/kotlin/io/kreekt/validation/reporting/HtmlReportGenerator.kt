...
internal class HtmlReportGenerator(
    ...
    private fun StringBuilder.appendBody(report: ProductionReadinessReport, includeCharts: Boolean) {
        appendHeader(report)
    ...
    private fun StringBuilder.appendExecutiveSummary(report: ProductionReadinessReport) {
        ...
        appendLine("        </div>")
        appendLine("        <div class='overall-score'>Overall Score: ${formatters.formatPercentage(report.overallScore)}</div>")
        appendLine("    </div>")
        appendLine("</div>")
    }
    ...
    private fun StringBuilder.appendCategoryScores(report: ProductionReadinessReport, includeCharts: Boolean) {
