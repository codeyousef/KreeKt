...
import io.kreekt.validation.utils.format
 ...
 *
 * This validator benchmarks the KreeKt library's runtime performance,
...
class PerformanceValidator : Validator<PerformanceMetrics> {
    ...
    /**
     * Benchmarks performance metrics for the KreeKt library.
     *
     * This method will:
