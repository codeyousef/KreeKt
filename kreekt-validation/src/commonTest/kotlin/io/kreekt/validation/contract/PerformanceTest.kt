...
import io.kreekt.validation.services.PerformanceValidator
import io.kreekt.validation.models.ValidationConfiguration.PerformanceRequirements
...
class PerformanceTest {
    ...
    fun `validatePerformance should validate against constitutional requirements`() = runTest {
        ...
        if (meetsFpsRequirement && meetsMemoryRequirement) {
            assertTrue(result.status == io.kreekt.validation.models.ValidationStatus.PASSED)
        }
    }
